  ...
  async function generateAnswer(e) {
    ...
    try {
      const response = await axios({
        url: `https://lemurbot.p.rapidapi.com/category-groups/%7Bid%7D',key=52c2eb3079msh923204a2c2e1158p11e837jsn0bc86c535376', ${
      ...
      console.log(error);
      setChatHistory((prev) => [...prev, { type: 'answer', content: "get me answer" }]);
    }
